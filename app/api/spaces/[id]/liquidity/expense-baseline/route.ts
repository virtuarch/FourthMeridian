/**
 * GET /api/spaces/[id]/liquidity/expense-baseline
 *
 * v2.6-ASSESS-3 — the Space's RESOLVED monthly-expense baseline, for the
 * Liquidity workspace's coverage line.
 *
 * ── Why this exists ─────────────────────────────────────────────────────────
 *
 ...
 * consumed it immediately; the Liquidity workspace could not, because the two
 ...
 * lazily — only when the Liquidity perspective is actually open — rather than
