 ...
 *
 * Returns the latest 30 normalized workspace activity events for the
 * TimelineWidget, sourced from AuditLog rows scoped to this workspace.
 *
 * Security:
 ...
 *
 * Filtered out (noise):
 *   - WORKSPACE_SWITCH — internal navigation, not meaningful to members
 *   - LOGIN / LOGOUT / LOGIN_FAILED — personal auth events, not workspace-scoped
...
const ALLOWED_ACTIONS = new Set([
  // Workspace lifecycle
  "WORKSPACE_CREATED", "WORKSPACE_CREATE", "WORKSPACE_UPDATE",
  // Members
  ...
  switch (log.action) {
    ...
    case "WORKSPACE_CREATE":
      return {
        ...
        subtitle: str(meta.name) || "A new workspace was created",
      };
    ...
    case "WORKSPACE_UPDATE":
      return {
        ...
        subtitle: "Workspace details were edited",
      };
    ...
    case "MEMBER_JOINED":
      return {
        ...
        actorName: actor,
        title:    "Member joined",
        subtitle: actor ? `${actor} joined the workspace` : "A new member joined",
      };
    ...
    case "WORKSPACE_REMOVE_MEMBER": {
      ...
      return {
        ...
        subtitle: `${removedName} was removed from the workspace`,
      };
    }
    ...
    case "WORKSPACE_LEAVE":
      return {
        ...
        actorName: actor,
        title:    "Member left",
        subtitle: actor ? `${actor} left the workspace` : "A member left the workspace",
      };
    ...
    case "ACCOUNT_SHARE_REVOKE": {
      ...
      return {
        ...
        subtitle: `${actor ?? "Someone"} removed ${accountName} from this workspace`,
      };
    }
...
export const GET = withApiHandler(async (
  ...
  // WORKSPACE_CREATED naturally falls to the bottom because it's the oldest event.
...
// Re-export the type so WorkspaceDashboard can import it if needed
