...
check('J8 FORECAST-1/2/3 are untouched',
  execSync('git diff --name-only f849c05 -- lib/forecast/cadence.ts lib/forecast/stream-activity.ts lib/forecast/future-cash-event.ts',
    { encoding: 'utf8' }).trim() === '');
