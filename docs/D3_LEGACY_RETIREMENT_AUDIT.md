...
| **Planning/historical docs** (decision record, not code) | 18 | `docs/D3_STEP4D_IMPLEMENTATION_REPORT.md`, `docs/D3_STEP4C_REGRESSION_ROOT_CAUSE.md`, `docs/D3_STEP4C_IMPLEMENTATION_REPORT.md`, `docs/D3_STEP3_HOME_SEMANTICS_CORRECTION.md`, `docs/D3_STEP4C_CORE_DASHBOARD_REVIEW.md`, `docs/D3_STEP4_READ_CUTOVER_REVIEW.md`, `docs/D3_STEP3_DUAL_WRITE_REVIEW.md`, `docs/D3_STEP2_BACKFILL_REVIEW.md`, `docs/D3_SPACE_ACCOUNT_LINK_REVIEW.md`, `docs/D2_CONNECTION_ARCHITECTURE_REVIEW.md`, `docs/BUGFIX_ARCHIVED_ACCOUNT_SNAPSHOT_STALENESS.md`, `docs/D1_DUPLICATE_ACCOUNT_CANDIDATE_DESIGN_REVIEW.md`, `docs/PHASE_2_DECISION_MATRIX.md`, `docs/PHASE_2_ARCHITECTURE_FREEZE.md`, `docs/WORKSPACE_TO_SPACE_RENAME_PLAN.md`, `docs/DATABASE_ARCHITECTURE_REVIEW.md`, `docs/releases/v2.0.1.md`, `fourth-meridian-product-language.md` |
...
5. **Remove table/relations:** only after explicit confirmation that `docs/PHASE_2_ARCHITECTURE_FREEZE.md`'s protection on this table is meant to be lifted at this point. Then: one migration to drop the table, one schema edit to remove the model and its four back-relations.
