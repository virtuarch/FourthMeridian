> **ARCHIVED — historical record.** The Workspace → Space rename completed at v2.3.0. Kept for historical context only. For current project status see `STATUS.md` at the repository root.
