> **SUPERSEDED — archived historical record.** This snapshot (last updated 2026-06-11) predates Phase 2. For current project status see `STATUS.md` at the repository root.
