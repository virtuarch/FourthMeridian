...
Evidence base: `v2.6-INVESTIGATION-TRANSFER-TRUTH-EVIDENCE-ARCHITECTURE.md` plus one further
...
- Modelling a state no provider attests is already a standing prohibition in this
  repository (`docs/plans/v2.6-INVESTIGATION-PENDING-BALANCE-CURRENT-STATE.md`, doctrine 8).
