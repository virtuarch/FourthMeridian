...
| Decimal / int-cents money migration | High-churn schema period; migration is large. Precision debt is inventoried in [../architecture/decisions/DEC-0.md](../architecture/decisions/DEC-0.md) | Plan during v2.5; execute post-v2.6b |
