# Doctrine — Financial Semantic Authorities

*Governs which single module decides each financial truth, what that authority means, and what each surface must never be used for. These are binding rules, not a status report. See also [money & FX](./money-and-fx.md), [transactions](../systems/transactions.md), [cash flow](../systems/cash-flow.md), [debt](../systems/debt.md), [investments](../systems/investments.md).*
...
*The full multi-currency rule-book is [money & FX](./money-and-fx.md). The authority summary below is its financial-semantic face.*
