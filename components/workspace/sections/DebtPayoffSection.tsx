 ...
 * DebtPayoffSection
 *
 * Interactive debt payoff planner for workspace dashboards.
 * Supports both an embedded card view and a full-screen modal view.
 *
 * Extracted from WorkspaceDashboard.tsx to keep that file manageable.
 */
...
// Structurally compatible with WorkspaceDashboard's WorkspaceAccount type.
 ...
 * summary text in WorkspaceDashboard) don't have to duplicate the logic.
 */
